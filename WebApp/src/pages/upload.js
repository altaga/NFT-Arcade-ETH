...
class Upload extends Component {
    ...
    mintNFT() {
        ...
        mint_contract.methods.mintNFT(this.props.my_ipfslink.ipfslink.nft, (this.state.price * unitMap[this.state.currency]).toString()).send().on('transactionHash', (hash) => {
            this.unirest('GET', 'https://gp1x01febi.execute-api.us-east-1.amazonaws.com/arcade-PutDB')
                .headers({
                    'pubkey': this.props.my_pubkey.pubkey,
                    ...
                    <div>
                        ...
                        }
                        {
                            ...
                            <div style={{ paddingTop: "12vh" }}>
                                <SimpleReactFileUpload url={"https://gp1x01febi.execute-api.us-east-1.amazonaws.com/arcade-NFTupload"} />
                            </div>
                        }
                        {
                        ...
                        }
                        {
                            ...
                            <>
                                ...
                                <div style={{ paddingTop: "3vh" }}>
                                    <Button style={{ borderRadius: "25px 0px 0px 25px", fontSize: "1.5rem", borderRight: "1px solid black", background: ` #d209c3` }} onClick={() => window.open(this.state.finalUrl, "_blank")}>View on Etherscan</Button>
